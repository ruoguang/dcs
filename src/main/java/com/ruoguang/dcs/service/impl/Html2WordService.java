...
import com.ruoguang.dcs.util.DownloadUtils;
...
public class Html2WordService {
    ...
    public String excute(String pageUrl) throws Exception {
        String outputPath = new StringBuffer("/output/").append(DateUtil.format(new Date(), "yyyyMMdd")).append("/word/").append(UuidUtils.uuid32()).append(".doc").toString();
    ...
    private String loadCssFileStrToHtml(String pageUrl, String htmlText) {
        ...
        while (m_link.find()) {
            ...
            if (StringUtils.isBlank(linkCssHref) || !linkCssHref.endsWith(".css")) {
